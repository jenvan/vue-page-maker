        ...
        <div :class="$style.row">
            ...
            <div :class="$style.extend">
                <div>
                    ...
                    <el-input-number :class="$style.width" v-model="width" :min="0" :max="1180" controls-position="right" title="图片宽度"></el-input-number>
                </div>
...
export default {
    ...
    computed: {
        ...
        ...importComputedFn(['image', 'text1', 'text2', 'text3', 'direction', 'width', 'animate', 'style']),
    },
    methods: {
        ...importMethodsFn(),
    }
